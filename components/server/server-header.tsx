...
import { ChevronDown, LogOut, PlusCircle, SettingsIcon, Trash, User, UserPlus, Users, UsersIcon } from "lucide-react";
    ...
    <DropdownMenu>
      ...
      >
        <button
          ...
          dark:border-neutral-800 border-b-2 hover:bg-zinc-700/10 dark:hover:bg-slate-700/50
          transition"   
        >
          {server.name}
          <ChevronDown 
